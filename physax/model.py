...
class Model:
    ...
    def init_population(self, key) -> Agent:
        ...
        h = random.uniform(k_h, (self.cfg.pop_size, 1))
        s = random.uniform(k_s, (self.cfg.pop_size, 1), minval=0.7, maxval=1.0)
        v = random.uniform(k_v, (self.cfg.pop_size, 1), minval=0.8, maxval=1.0)
